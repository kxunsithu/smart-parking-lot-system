...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Home / Landing
    "home.hero_badge": "Yangon's Smart Parking Platform",
    ...
    "home.nearby_lots": "Parking Lots in Yangon",
    "home.why_smart": "Why Smart Parking?",
    "home.why_subtitle": "Everything you need for seamless vehicle parking in Yangon.",
    ...
    "home.step2_desc": "Browse available parking lots in Yangon and check real-time slot availability.",
    ...
    "home.cta_subtitle": "Join thousands of drivers using Smart Parking to save time and money in Yangon.",
  ...
  mm: {
    ...
    // Home / Landing
    "home.hero_badge": "ရန်ကုန်မြို့ စမတ် ယာဉ်ရပ်နားစခန်း စနစ်",
    "home.hero_title_1": "လွယ်ကူစွာ ရပ်နားပါ၊",
    "home.hero_title_2": "အချိန်ကုန် သက်သာပါ",
    "home.hero_subtitle": "ရန်ကုန်မြို့အတွင်း ယာဉ်ရပ်နားရန် နေရာများကို လွယ်ကူစွာ ရှာဖွေ၊ ကြိုတင် ရပ်နား၊ စီမံခန့်ခွဲနိုင်ပါသည်။",
    ...
    "home.why_subtitle": "ရန်ကုန်မြို့အတွင်း စနစ်တကျ လွယ်ကူစွာ ယာဉ်ရပ်နားနိုင်မည့် ဝန်ဆောင်မှုများ",
    ...
    "home.step2_desc": "ရန်ကုန်မြို့အတွင်းရှိ စခန်းများနှင့် လွတ်လပ်သော နေရာများကို တိုက်ရိုက် ကြည့်ရှုပါ။",
    ...
    "home.cta_subtitle": "ရန်ကုန်မြို့အတွင်း အချိန်နှင့် ငွေကြေး သက်သာစေရန် Smart Parking ကို အသုံးပြုလိုက်ပါ။",
