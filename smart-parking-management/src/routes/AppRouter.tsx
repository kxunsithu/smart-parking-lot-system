...
const AdminPaymentsPage = lazy(() =>
  import("@/pages/admin/PaymentsPage").then((m) => ({ default: m.AdminPaymentsPage }))
)
...
const OwnerWalletPage = lazy(() =>
  import("@/pages/owner/WalletPage").then((m) => ({ default: m.OwnerWalletPage }))
)
