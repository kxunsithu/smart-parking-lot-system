...
def upgrade() -> None:
    ...
    with op.batch_alter_table('cars', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_cars_plate_number'), ['plate_number'], unique=True)
    ...
    with op.batch_alter_table('parking_sessions', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_parking_sessions_car_id', ['car_id'], unique=False)
        batch_op.create_index('ix_parking_sessions_car_status', ['car_id', 'status'], unique=False)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('parking_sessions', schema=None) as batch_op:
        batch_op.drop_index('ix_parking_sessions_car_status')
        batch_op.drop_index('ix_parking_sessions_car_id')
    ...
    with op.batch_alter_table('cars', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_cars_plate_number'))
